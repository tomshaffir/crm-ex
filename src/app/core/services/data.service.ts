...
export class DataService {
    ...
    AddItemsToCustomer(customerId: number, newItems: IOrder[]) {
        const reqBody = { customerId, newItems };
        return this.http.post<boolean>(this.baseUrl + '/api/addItemsToCustomer', reqBody)
            .pipe(catchError(this.handleError));
    }
